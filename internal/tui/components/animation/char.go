...
// // NewChar creates a new Anim instance with the specified width and label.
// func NewChar(opts Settings) *Anim {
// 	a := &Anim{}
// 	// Validate settings.
// 	if opts.Size < 1 {
...
// 		// Only process messages for char animation type
// 		if msg.AnimType != types.AnimationTypeChar {
// 			return a, nil
// 		}
// 		// If ID is set, check if it matches this instance
// 		if msg.ID != 0 && msg.ID != a.id {
...
// 		return messages.StepMsg{
// 			AnimType: types.AnimationTypeChar,
// 			ID:       a.id,
// 		}
// 	})
// }
